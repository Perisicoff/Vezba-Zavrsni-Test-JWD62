...
import NoviLjubimac from './components/ljubimci/DodajLjubimca';
              ...
              <Router>
                ...
                Pet Shop
                  ...
                  <Nav className="navbar-links-center">
                    <Nav.Link className="text-white bg-dark" as={Link} to="/ljubimci">
                      Kucni ljubimci
                    </Nav.Link>
                ...
                <Container style={{paddingTop:"25px"}}>
                  <Routes>
                    ...
                    <Route path="/ljubimac/add" element={<NoviLjubimac/>}/>
              ...
              <Router>
                ...
                <Navbar.Brand as={Link} to="/">
                  ...
                  <Nav.Link className="text-white bg-dark" as={Link} to="/registracija">
                    ...
                    <Button className="btn btn-light btn-sm" as={Link} to="/login">Login</Button>
                </Navbar>
                <Container style={{paddingTop:"25px"}}>
                  <Routes>
                    <Route path="/" element={<Home/>} />
